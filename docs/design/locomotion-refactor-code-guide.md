...
> **状态：设计已冻结，代码尚未按本文实施。** 本文把 [普通移动系统重构冻结方案](locomotion-refactor.md) 拆成可逐阶段执行的代码任务。玩法、位移所有权与 L0～L5 顺序仍以前述冻结方案和 [阶段门禁](milestone-gates.md#5-l普通移动重构门禁) 为准；本文负责回答“AI 应改哪些代码、不得改什么、如何验证”。
>
